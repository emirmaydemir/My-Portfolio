      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <motion.div initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className="col-span-8 place-self-center text-center sm:text-left justify-self-start">
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-7xl lg:leading-normal font-extrabold">
            ...
            <br></br>
            <TypeAnimation sequence={["Full Stack Developer", 1000, "Back-End Developer", 1000, "Front-End Developer", 1000, "UI/UX Designer", 1000, "Web Developer", 1000, "Mobile Developer", 1000, "ERP Software Developer", 1000, "Emir Muhammet Aydemir", 1000]} wrapper="span" speed={50} repeat={Infinity} />
          </h1>
