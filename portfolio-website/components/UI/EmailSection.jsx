  ...
  return (
    <motion.section id="contact" className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.3 }}>
      ...
      <motion.div className="z-10" variants={itemVariants}>
        <h5 className="text-xl font-bold text-white my-2">{emailContent.email_title}</h5>
        <p className="text-[#ADB7BE] mb-4 max-w-md">{emailContent.email_description}</p>
        ...
        {emailSubmitted ? (
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input name="email" type="email" id="email" required className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5" placeholder="emir@google.com" />
            </div>
            <div className="mb-6">
              <label htmlFor="subject" className="text-white block text-sm mb-2 font-medium">
                {emailContent.email_subject}
              </label>
              <input name="subject" type="text" id="subject" required className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5" placeholder={emailContent.email_subject_description} />
            </div>
            <div className="mb-6">
              <label htmlFor="message" className="text-white block text-sm mb-2 font-medium">
                {emailContent.email_message}
              </label>
              <textarea name="message" id="message" className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5" placeholder={emailContent.email_message_description} />
            </div>
