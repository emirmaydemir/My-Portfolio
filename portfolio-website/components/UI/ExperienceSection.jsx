...
const experiences = [
  ...
  },
  {
    ...
    date: "2019 - 2023",
    description: "Marmara Üniversitesinde 3. sınıf bilgisayar mühendisliği öğrencisiyim.",
    icon: "education",
        ...
        {experiences.map((exp, idx) => (
          <motion.a key={exp.id} href={exp.url} target="_blank" rel="noopener noreferrer" variants={itemVariants} transition={{ duration: 0.5 }} className="relative flex items-stretch group">
            ...
            <div className="relative flex flex-col items-center mr-6">
              <div className="w-10 h-10 rounded-full bg-yellow-400 flex items-center justify-center text-black shadow-lg z-10 group-hover:scale-110 transition-transform duration-300">{exp.icon === "work" ? <Briefcase size={20} /> : <GraduationCap size={20} />}</div>
